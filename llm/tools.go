...
type ToolCall struct {
	...
	// WebSearchToolCall holds the web search call data for OpenAI Responses API.
...
// WebSearchToolCall represents a web search call from the OpenAI Responses API.
type WebSearchToolCall struct {
	// ID is the Responses output item identifier.
	ID string `json:"id,omitempty"`
	// Status is the current web search state, e.g. "in_progress", "searching", or "completed".
